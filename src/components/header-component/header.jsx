  ...
  return (
    <Fragment>
      <header className={onScrollClass}>
        <nav className="header__nav">
          <ul className="header__ul">
            <li onClick={handleScrollHome} className="header__item">
              Hello
            </li>
            <li onClick={handleScrollProjects} className="header__item">
              Projects
            </li>
            <li className="header__item">
              <a href="https://portfolio-blog-coral.vercel.app" target="_blank" rel="noreferrer">
                Blog
              </a>
            </li>
            <li onClick={handleScrollAbout} className="header__item">
              About
            </li>
          </ul>
        </nav>
      ...
      <Box
        ...
        sx={{ alignItems: 'center', textAlign: 'center', marginRight: '0px' }}
      >
        <IconButton
          onClick={handleClick}
          size="small"
      ...
      <aside className={isOpen ? 'aside' : 'aside-none'}>
        ...
        <nav className="aside__nav">
          <ul className="aside__ul">
            <li onClick={handleScrollHome} className="aside__item">
              Hello
            </li>
            <li onClick={handleScrollProjects} className="aside__item">
              Projects
            </li>
            <li className="header__item">
              <a href="https://portfolio-blog-coral.vercel.app" target="_blank" rel="noreferrer">
            ...
            <li onClick={handleScrollAbout} className="aside__item">
              About
            </li>
          </ul>
        </nav>
